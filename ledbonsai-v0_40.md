...
| **Monochrome** | Single-color mode. Eight presets: Phosphor Green, Amber, Ice Blue, Cyan, Hot Pink, Red, White, Violet. Pick any color with the color picker or choose a preset. |
...
4. On Raspberry Pi, launch Chromium in kiosk mode to hide the browser UI:
   ```
   chromium-browser --kiosk file:///path/to/ledbonsai-v0_40.html
   ```
