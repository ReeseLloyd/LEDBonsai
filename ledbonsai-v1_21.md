...
Open `ledbonsai-v1_21.html` in any modern web browser. A tree generates automatically on load. Click **Start** to make a new one, or **Randomize** (🎲) to shuffle the seed and generate, or **🎰** to randomize all settings (tree type, palette, structure sliders, and seed) before generating.
